      ...
      <div className='grid  grid-cols-6 gap-6 mt-16'>
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute right-0 left-0 bottom-0'>
            <strong className='font-bold text-white block'>League Of Legendas</strong>
        ...
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute right-0 left-0 bottom-0'>
            <strong className='font-bold text-white block'>COCA 2</strong>
            <span className='text-zinc-300 text-sm block'>4 anúncios</span>
          </div>
        </a>
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute right-0 left-0 bottom-0'>
            <strong className='font-bold text-white block'>BF -> NO</strong>
            <span className='text-zinc-300 text-sm block'>4 anúncios</span>
          </div>
        </a>
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute right-0 left-0 bottom-0'>
            <strong className='font-bold text-white block'>Pew Pew Legends</strong>
            <span className='text-zinc-300 text-sm block'>4 anúncios</span>
          </div>
        </a>
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute right-0 left-0 bottom-0'>
            <strong className='font-bold text-white block'>Fork and Knife</strong>
            <span className='text-zinc-300 text-sm block'>4 anúncios</span>
          </div>
        </a>
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute right-0 left-0 bottom-0'>
            <strong className='font-bold text-white block'>Word of Wobbuffet</strong>
            <span className='text-zinc-300 text-sm block'>4 anúncios</span>
          </div>
        </a>
      </div>
